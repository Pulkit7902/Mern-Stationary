...
const HorizonatalCardProduct = ({category ,heading}) => {
    ...
    <div className='container mx-auto px-4 my-7 relative'>
                ...
                <button className='bg-white shadow-md rounded-full p-1 absolute right-0 hidden md:block' onClick={scrollright} ><MdOutlineNavigateNext/></button>
        {
            data.map((product  , index)=>{
                return(
                    <Link to={"product/" + product?._id} className='w-full min-w-[380px] md:min-w-[380px] max-w-[380px] md:max-w-[380px] h-36 bg-white rounded-sm shadow-md flex'>
                    <div className='bg-slate-200 h-full p-2 min-w-[120px] md:min-w-[100px]'>
                    ...
                    <div className='p-4 grid'>
                        ...
                        <button  class ='add-to-cart-button' className='text-sm hover:bg-purple-700  bg-purple-500 px-2 py-1 rounded-full' onClick={(e)=>handlecart(e, product?._id)}>Add to cart</button>   
...
export default HorizonatalCardProduct
